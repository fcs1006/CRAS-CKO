...
export async function GET(request: NextRequest) {
  try {
    ...
    // Se for admin ou coordenador, retorna os dados completos de gestão.
    // Se for técnico ou recepção, restringe aos dados públicos profissionais para seleção em atendimentos (sem expor CPF/usuario, email e telefone pessoal).
    let query = supabase
      .from('usuarios')

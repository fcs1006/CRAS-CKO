...
export function ModalEditarFamilia({ familia, familiasExistentes, usuarios = [], onClose, onSalvar }: ModalEditarFamiliaProps) {
  ...
  const [acessibilidade, setAcessibilidade] = useState(Boolean(familia.acessibilidade))
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setAlertaModal({
        ...
        mensagem: err.message || 'Ocorreu um erro ao atualizar o prontuário. Tente novamente.',
        textoBotao: 'Fechar'
      })
    } finally {
      setSalvando(false)

...
interface DashboardViewProps {
  ...
  totalFamiliasContagem?: number
  totalPaifContagem?: number
...
export function DashboardView({
  ...
  usuarios = [],
  usuarioLogado,
  totalFamiliasContagem,
  totalPaifContagem,
  onNavegarTab,
  onAbrirModalNovoAtendimento,
  onAbrirModalNovaFamilia
}: DashboardViewProps) {
  const totalFamilias = totalFamiliasContagem !== undefined ? totalFamiliasContagem : familias.length
  const paifAtivas = totalPaifContagem !== undefined ? totalPaifContagem : familias.filter(f => f.paif_ativo).length
        ...
        >
          <div className="flex justify-between items-start">
            <div>
              ...
              <h3 className="text-3xl font-black text-gray-900 mt-1 font-mono">{totalFamilias.toLocaleString('pt-BR')}</h3>
            </div>
        ...
        >
          <div className="flex justify-between items-start">
            <div>
              ...
              <h3 className="text-3xl font-black text-emerald-900 mt-1 font-mono">{paifAtivas.toLocaleString('pt-BR')}</h3>
            </div>

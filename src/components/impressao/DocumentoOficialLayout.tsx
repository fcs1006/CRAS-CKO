...
export function DocumentoOficialLayout({
  ...
  return (
    <div className={`print-document-container relative flex flex-col justify-between ${subirAssinaturas ? 'min-h-0 pb-4 print:pb-1' : 'min-h-[250mm] sm:min-h-[255mm] pb-10 print:pb-8'} print:min-h-0 text-black font-sans w-full max-w-full overflow-hidden`}>
      {/* Conteúdo Principal do Documento */}
      <div className="space-y-2 flex-1 w-full max-w-full overflow-hidden">
      ...
      {assinaturas && (
        <div className={`${subirAssinaturas ? 'mt-0.5 pt-0 space-y-7' : 'mt-auto pt-6 space-y-4'} shrink-0 break-inside-avoid page-break-inside-avoid print:break-inside-avoid print:page-break-inside-avoid`}>
          <div className="text-right text-[10px] font-bold pb-2 pr-2 text-black">
      ...
      <div className="print-fixed-footer print:block pt-1.5 border-t border-black text-center text-[9px] text-black w-full mt-2">
